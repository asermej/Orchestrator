...
The frontend application for the Surrova Platform, built with Next.js 15 and modern React patterns.
...
```
apps/orchestrator/Orchestrator.Web/
├── README.md                          # This file
...
1. **Navigate to web directory:**
   ```bash
   cd apps/orchestrator/Orchestrator.Web
   ```
...
From the web directory (`apps/orchestrator/Orchestrator.Web`):
