...
public static class AgentMapper
{
    ...
    public static AgentResource ToResource(Agent agent, bool isInherited = false, string? ownerOrganizationName = null)
    {
        ...
        return new AgentResource
        {
            ...
            Tone = agent.Tone,
            Pace = agent.Pace,
            AcknowledgmentStyle = agent.AcknowledgmentStyle,
    ...
    public static Agent ToDomain(CreateAgentResource createResource, Guid groupId)
    {
        ...
        return new Agent
        {
            ...
            Tone = createResource.Tone,
            Pace = createResource.Pace,
            AcknowledgmentStyle = createResource.AcknowledgmentStyle,
            AdditionalInstructions = createResource.AdditionalInstructions,
    ...
    public static Agent ToDomain(UpdateAgentResource updateResource, Agent existingAgent)
    {
        ...
        return new Agent
        {
            ...
            Tone = updateResource.Tone ?? existingAgent.Tone,
            Pace = updateResource.Pace ?? existingAgent.Pace,
            AcknowledgmentStyle = updateResource.AcknowledgmentStyle ?? existingAgent.AcknowledgmentStyle,
            AdditionalInstructions = updateResource.AdditionalInstructions ?? existingAgent.AdditionalInstructions,
