...
import { createJobType, InterviewQuestion } from "../actions";
...
export default function NewJobTypePage() {
  ...
  const [questions, setQuestions] = useState<InterviewQuestion[]>([
    { questionText: "", questionOrder: 0, isRequired: true, maxFollowUps: 1 },
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (questions.filter((q) => q.questionText.trim()).length === 0) {
      setError("At least one interview question is required");
      return;
    }
    ...
    try {
      ...
      setError("Failed to create job type. Please try again.");
    } finally {
      setIsSaving(false);
    }
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <form onSubmit={handleSubmit}>
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>Create Job Type</CardTitle>
            </CardHeader>
