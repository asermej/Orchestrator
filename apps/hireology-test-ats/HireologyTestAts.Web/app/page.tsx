...
const cards = [
  {
    href: "/jobs",
    title: "Jobs",
    description: "Manage and sync jobs to Orchestrator",
    icon: (
  ...
  },
  {
    href: "/applicants",
    title: "Applicants",
    description: "Manage and sync applicants",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    href: "/settings",
    title: "Settings",
    description: "Orchestrator connection (API URL, API key)",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    href: "/careers",
    title: "Careers",
    description: "Public career site with chatbot widget",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-1 text-slate-500">
          Manage your jobs, applicants, and Orchestrator integration.
        </p>
      </div>
