...
internal sealed partial class GatewayFacade
{
    ...
    {
        return await OrchestratorManager.GetInterviewTemplates(groupApiKey).ConfigureAwait(false);
    }
        ...
        string externalApplicantId, string externalJobId, Guid interviewTemplateId, string? groupApiKey, Guid? agentId = null)
    {
        return await OrchestratorManager.CreateInterview(
            externalApplicantId, externalJobId, interviewTemplateId, groupApiKey, agentId).ConfigureAwait(false);
    }
